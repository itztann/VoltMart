...
<body>
    ...
    <section id="home" class="product-showcase">
    ...
    <section id="aboutUs" class="about-us-section">
        <h2>About Us</h2>
        <p>Welcome to VoltMart, your premier destination for the latest and greatest in electronics. At VoltMart, we are passionate about delivering high-quality gadgets and devices to tech enthusiasts, professionals, and everyday users. From cutting-edge laptops, smartphones, and tablets to essential home appliances, our extensive catalog is designed to meet all your electronic needs.</p>
        <p>Founded on the principles of innovation, affordability, and exceptional customer service, VoltMart strives to provide an unmatched shopping experience. Our team is dedicated to sourcing only the best products from trusted brands, ensuring that you receive top-notch quality with every purchase. Whether you are upgrading your tech collection, shopping for gifts, or seeking the latest in electronic advancements, VoltMart is here to help you stay connected and powered up.</p>
        <p>Thank you for choosing VoltMart. We look forward to serving you and meeting all your electronics needs!</p>
    </section>    
    ...
    <footer id="contacts"> 
        <div class="ftr-txt">
            <div class="ftr-ig">
                ...
                <div class="ig">
                    <a href="https://www.instagram.com/" target="_blank">@VoltMart</a>
                </div>
            </div>
            ...
            <div class="ftr-company">
                ...
                <div class="company">
                    ...
                    <div class="ftr-section">
                        <svg xmlns="http://www.w3.org/2000/svg" class="ftr-logo" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="white" d="M7.8 2h8.4C19.4 2 22 4.6 22 7.8v8.4a5.8 5.8 0 0 1-5.8 5.8H7.8C4.6 22 2 19.4 2 16.2V7.8A5.8 5.8 0 0 1 7.8 2m-.2 2A3.6 3.6 0 0 0 4 7.6v8.8C4 18.39 5.61 20 7.6 20h8.8a3.6 3.6 0 0 0 3.6-3.6V7.6C20 5.61 18.39 4 16.4 4H7.6m9.65 1.5a1.25 1.25 0 0 1 1.25 1.25A1.25 1.25 0 0 1 17.25 8A1.25 1.25 0 0 1 16 6.75a1.25 1.25 0 0 1 1.25-1.25M12 7a5 5 0 0 1 5 5a5 5 0 0 1-5 5a5 5 0 0 1-5-5a5 5 0 0 1 5-5m0 2a3 3 0 0 0-3 3a3 3 0 0 0 3 3a3 3 0 0 0 3-3a3 3 0 0 0-3-3Z"/></svg>                
                        <a href="https://www.instagram.com/">@VoltMart</a>
                    </div>
                </div>
            </div>
        </div>
